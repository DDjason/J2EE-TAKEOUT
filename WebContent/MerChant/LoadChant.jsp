...
function loadXMLDoc(url){
 ...
 function Load(){
	 ...
	 loadXMLDoc( "ChantLoad.jsp?name=" + Loadname +
...
function GetResult(){
	...
	if(xmlhttp.readyState == 4){
		if(xmlhttp.status == 200){
			...
			var panduan= xmlhttp.responseText;
			alert(panduan);
			if(panduan == 1)
			{
				window.location.href="Meichantchoose.jsp?useid="+Loadname;
			} 
...
<style type="text/css">
body {background-image: url("../img/201.jpg");}
